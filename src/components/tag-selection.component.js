import { Autocomplete, AutocompleteItem, Button, ButtonGroup, Card, Icon, Layout, Modal, Text } from '@ui-kitten/components'
            ...
            <Layout style={styles.layout}>
                {
                    tag ?
                        (
                            <Breadcrumb textEdit='Thème' onPress={() => setDisplayModal(true)} items={tag.split('/')} />
                        ) :
                        (
